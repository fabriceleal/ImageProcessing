...
{
    /// <summary>
    /// Apply the geometric mean filter to an image.
    /// </summary>
    /// <remarks>Computes the output pixels by evaluating the geometric mean 
    /// of the neighborhood of the pixel.
    /// </remarks>
    [Filter("Geometric Mean", "Geometric Mean Filter",
            "Computes the output pixels by evaluating the geometric mean" +
            " of the neighborhood of the pixel.",
            new string[] { "Smoothing", "Mean" }, true)]
    [SmoothMetric]
    public class GeometricMean : SpatialDomainFilter
    {
