...
namespace Framework.Filters.Sharpening
{
    ...
    /// <summary>
    /// Apply the ideal high pass to an image.
    /// </summary>
    /// <remarks>
    /// The ideal high pass filter cuts off all frequencies within a certain distance from the center 
    /// (cutting off low frequency values).
    /// (Gonzalez, R. C., Woods, R. E.. Digital Image Processing.2.Prentice Hall)
    /// </remarks>
    [Filter("Ideal", "Ideal Sharpening Filter",
            "The ideal highpass filter cuts off all frequencies within" + 
